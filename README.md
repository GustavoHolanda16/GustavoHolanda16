...
| [Plot Pulse](https://github.com/GustavoHolanda16/filmes) | Site para visualiação de inforações de filmes e seires | HTML, CSS, JavaScript, API|
| [Marque Bem](https://github.com/GustavoHolanda16/Marque_Bem) | Sistema de agendamento de consultas e exames medicos | Python, Flask, SQlite |
